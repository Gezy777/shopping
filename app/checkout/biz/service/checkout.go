...
import (
	...
	"github.com/cloudwego/biz-demo/gomall/app/checkout/mq"
	"github.com/cloudwego/biz-demo/gomall/app/checkout/rpc"
...
func (s *CheckoutService) Run(req *checkout.CheckoutReq) (resp *checkout.CheckoutResp, err error) {
	...
	data, _ := proto.Marshal(&email.EmailReq{
		...
		Content: "You have just created an order in thu CloudWeGo shop",
	})
