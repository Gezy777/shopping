...
// GetProductByName implements the ProductCatalogServiceImpl interface.
func (s *ProductCatalogServiceImpl) GetProductByName(ctx context.Context, req *product.GetProductByNameReq) (resp *product.GetProductByNameResp, err error) {
	resp, err = service.NewGetProductByNameService(ctx).Run(req)
