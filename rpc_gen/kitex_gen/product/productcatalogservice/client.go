...
func (p *kProductCatalogServiceClient) GetProductByName(ctx context.Context, Req *product.GetProductByNameReq, callOptions ...callopt.Option) (r *product.GetProductByNameResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetProductByName(ctx, Req)
}
