...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"GetProductByName": kitex.NewMethodInfo(
		getProductByNameHandler,
		newGetProductByNameArgs,
		newGetProductByNameResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingUnary),
	),
...
func getProductByNameHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(product.GetProductByNameReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(product.ProductCatalogService).GetProductByName(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetProductByNameArgs:
		success, err := handler.(product.ProductCatalogService).GetProductByName(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetProductByNameResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetProductByNameArgs() interface{} {
	return &GetProductByNameArgs{}
}

func newGetProductByNameResult() interface{} {
	return &GetProductByNameResult{}
}

type GetProductByNameArgs struct {
	Req *product.GetProductByNameReq
}

func (p *GetProductByNameArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(product.GetProductByNameReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *GetProductByNameArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *GetProductByNameArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *GetProductByNameArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetProductByNameArgs) Unmarshal(in []byte) error {
	msg := new(product.GetProductByNameReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetProductByNameArgs_Req_DEFAULT *product.GetProductByNameReq

func (p *GetProductByNameArgs) GetReq() *product.GetProductByNameReq {
	if !p.IsSetReq() {
		return GetProductByNameArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetProductByNameArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetProductByNameArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetProductByNameResult struct {
	Success *product.GetProductByNameResp
}

var GetProductByNameResult_Success_DEFAULT *product.GetProductByNameResp

func (p *GetProductByNameResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(product.GetProductByNameResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *GetProductByNameResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *GetProductByNameResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *GetProductByNameResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetProductByNameResult) Unmarshal(in []byte) error {
	msg := new(product.GetProductByNameResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetProductByNameResult) GetSuccess() *product.GetProductByNameResp {
	if !p.IsSetSuccess() {
		return GetProductByNameResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetProductByNameResult) SetSuccess(x interface{}) {
	p.Success = x.(*product.GetProductByNameResp)
}

func (p *GetProductByNameResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetProductByNameResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetProductByName(ctx context.Context, Req *product.GetProductByNameReq) (r *product.GetProductByNameResp, err error) {
	var _args GetProductByNameArgs
	_args.Req = Req
	var _result GetProductByNameResult
	if err = p.c.Call(ctx, "GetProductByName", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
