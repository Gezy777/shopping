...
func GetProductByName(ctx context.Context, req *product.GetProductByNameReq, callOptions ...callopt.Option) (resp *product.GetProductByNameResp, err error) {
	resp, err = defaultClient.GetProductByName(ctx, req, callOptions...)
	if err != nil {
		klog.CtxErrorf(ctx, "GetProductByName call failed,err =%+v", err)
		return nil, err
	}
	return resp, nil
}
