...
type RPCClient interface {
	...
	GetProductByName(ctx context.Context, Req *product.GetProductByNameReq, callOptions ...callopt.Option) (r *product.GetProductByNameResp, err error)
...
func (c *clientImpl) GetProductByName(ctx context.Context, Req *product.GetProductByNameReq, callOptions ...callopt.Option) (r *product.GetProductByNameResp, err error) {
	return c.kitexClient.GetProductByName(ctx, Req, callOptions...)
}
